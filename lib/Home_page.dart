      ...
      home: Scaffold(
        ...
        body: Column(
          children: [
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('$_height cm',style: TextStyle(fontSize: 30),),
                ...
                Container(
                  ...
                  child:Column(
                    ...
                    children: [
                      ...
                      Text('$_weight',style: TextStyle(fontSize: 30),),

                      //+ - button
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceAround,
                        children: [
                          FloatingActionButton(onPressed: _subweight,
                            backgroundColor:Color(0xFFE88100),
                            child: Icon(Icons.minimize),
                            // heroTag: "btn3",
                          ),

                          FloatingActionButton(onPressed: _addweight,
                            backgroundColor:Color(0xFFE88100),
                ...
                Container(
                  ...
                  child:Column(
                    ...
                    children: [
                      ...
                      Text('$_age',style: TextStyle(fontSize: 30),),

                      //+ - button
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceAround,
                        children: [
                          FloatingActionButton(onPressed: _subage,
                            backgroundColor:Color(0xFFE88100),
                            child: Icon(Icons.minimize),
                            // heroTag: "btn1",
                          ),

                          FloatingActionButton(onPressed: _addage,
                            backgroundColor:Color(0xFFE88100),
                            child: Icon(Icons.add),
                            // heroTag: "btn2",
                          )
            ...
            Navigator.of(context).push(MaterialPageRoute(builder: (context)=>Result_pg(
              getcol: bgcol,
              stg: stage,
              gettxt: txt,
              getcal: calbmi,
